...
for i= 1:evl
    ...
    [p_z_k,z_k]=Prior_Simulation(int_var(:,1:2),int_cp_index,AMS,Covariate,obs_int,0.3,cha,z_z(:,1),Model_type{1,1},'norm',0,0.3);
    [p_z_sigma,z_sigma]=Prior_Simulation(int_var(:,3:4),int_cp_index,AMS,Covariate,obs_int,100,cha,z_z(:,2),Model_type{2,1},'norm',0,100);
    ...
    [p_z_k,z_k]=Prior_Simulation(int_var(:,1:2),int_cp_index,AMS,Covariate,obs_int,0.3,cha,z_z(:,1),Model_type{1,1},'norm',0,0.3);
    [p_z_sigma,z_sigma]=Prior_Simulation(int_var(:,3:4),int_cp_index,AMS,Covariate,obs_int,100,cha,z_z(:,2:end),Model_type{2,1},'norm',0,100);
