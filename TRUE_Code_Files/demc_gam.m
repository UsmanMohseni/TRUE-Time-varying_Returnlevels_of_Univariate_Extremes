...
% Preparing Initial Chains
[p_x_k,mix_k,x_k]=Prior_estimator(int_var(:,1:2),int_cp_index,AMS,Covariate,obs_int,1000,cha,Model_type{1,1},'norm',0,1000); %shape
[ p_x_sigma, mix_x_sig,x_sigma]=Prior_estimator(int_var(:,3:4),int_cp_index,AMS,Covariate,obs_int,1000,cha,Model_type{2,1},'norm',0,1000); %scale
...
for i= 1:evl
    ...
    [p_z_k,z_k]=Prior_Simulation(int_var(:,1:2),int_cp_index,AMS,Covariate,obs_int,1000,cha,z_z(:,1),Model_type{1,1},'norm',0,1000);
    [p_z_sigma,z_sigma]=Prior_Simulation(int_var(:,3:4),int_cp_index,AMS,Covariate,obs_int,1000,cha,z_z(:,2),Model_type{2,1},'norm',0,1000);
    ...
    [p_z_k,z_k]=Prior_Simulation(int_var(:,1:2),int_cp_index,AMS,Covariate,obs_int,100,cha,z_z(:,1),Model_type{1,1},'norm',0,1000);
    [p_z_sigma,z_sigma]=Prior_Simulation(int_var(:,3:4),int_cp_index,AMS,Covariate,obs_int,100,cha,z_z(:,2:end),Model_type{2,1},'norm',0,1000);
    ...
    [p_z_k,z_k]=Prior_Simulation(int_var(:,1:2),int_cp_index,AMS,Covariate,obs_int,100,cha,z_z(:,1:m),Model_type{1,1},'norm',0,1000);
    [p_z_sigma,z_sigma]=Prior_Simulation(int_var(:,3:4),int_cp_index,AMS,Covariate,obs_int,100,cha,z_z(:,m+1:end),Model_type{2,1},'norm',0,1000);
    ...
    [p_z_k,z_k]=Prior_Simulation(int_var(:,1:2),int_cp_index,AMS,Covariate,obs_int,100,cha,z_z(:,1:m),Model_type{1,1},'norm',0,1000);
    [p_z_sigma,z_sigma]=Prior_Simulation(int_var(:,3:4),int_cp_index,AMS,Covariate,obs_int,1000,cha,z_z(:,m+1:end),Model_type{2,1},'norm',0,1000);
    % [p_z_mu,z_mu]=Prior_Simulation(int_var(:,5:6),int_cp_index,AMS,Covariate,obs_int,100,cha,z_z(:,m+2:end),Model_type{3,1});
    end
