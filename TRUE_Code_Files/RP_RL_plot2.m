function RP_RL_plot2(params,best_fit,Time,Label,no)
    ...
    title('Return Period vs Return Level', 'FontSize', 14, 'FontWeight', 'bold', 'FontName', 'Times New Roman')
    ...
    grid on
      set(gcf, 'Color', 'w', 'Units', 'inches', 'Position', [1, 1, 7, 3]);  
