...
% Reference Publication: Mohseni U, Gailakoti M, Vinnarasi R, 2026
...
%for the access of .p files, the users are requested to contact the first
%author (Usman Mohseni: mohseni_ua@ce.iitr.ac.in)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fileLocation = "E:\TRUE-Time-varying_Returnlevels_of_Univariate_Extremes-main"; % location to store the figures
finalsave = "E:\TRUE-Time-varying_Returnlevels_of_Univariate_Extremes-main"; % workspace save location
