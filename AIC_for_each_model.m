...
%% Changes: comment it and uncomment the above code.
DATA=nan(21,5);
DATA(:,1)=1:21;
DATA(:,2)=hos21last;
DATA(:,3)=hos21last;
...
Covariate = DATA(:,5:end); %changed for mam's work
...
Total_simulations=1;
for simulation=1:Total_simulations
